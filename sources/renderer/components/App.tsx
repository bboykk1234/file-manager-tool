...
export default class App extends React.Component<{}, {}> {
  constructor(props: {}) {
    ...
    this.handleFinishedReadFilesMetadata =
      this.handleFinishedReadFilesMetadata.bind(this);
  }

  componentWillUnmount() {
    ipcRenderer.removeListener(
      'read-files-metadata-chunk-finished',
      this.handleFinishedReadFilesMetadata
    );
  }
    ...
    return (
      <>
        <input
          type='button'
          value='Select folder'
          onClick={this.listenFinishedReadFilesMetadata}
        />
      </>
    );
  }
